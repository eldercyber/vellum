...
<body>
    ...
    <form method="POST">
        <table style="width:75%; margin:0 auto; text-align:center">
            ...
            <tr>
                <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><h3>Enter Your First Name</h4></td>
                <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><input type="text" name="first_name"></td>
            </tr>
            
            <tr>
            <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><h3>Enter Your Last Name</h4></td>
                <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><input type="text" name="last_name"></td>
            </tr>
            
            <tr>
            <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><h3>Enter Your Date of Birth</h4></td>
                <td style="border:1px solid black; width:75%; margin:0 auto; text-align:center"><input type="date" name="dob"></td>
            </tr>
            </table>
